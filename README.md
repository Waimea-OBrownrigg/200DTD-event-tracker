...
My project will be an event tracker, a website where you can write down various upcoming events, and it will display them in order based on which is the closest.
